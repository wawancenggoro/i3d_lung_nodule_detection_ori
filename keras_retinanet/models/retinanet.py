...
def default_regression_model(num_values, num_anchors, pyramid_feature_size=256, regression_feature_size=256, name='regression_submodel'):
    ...
    print('Load retinanet.py default_regression_model.....................')
    # print('Debug model default_regression_model')
    # import IPython;IPython.embed()
...
def default_submodels(num_classes, num_anchors):
    ...
    return [
        ...
        ('classification', default_depths_model(2, num_anchors)),
        ('depthsification', default_classification_model(num_classes, num_anchors))
    ]
